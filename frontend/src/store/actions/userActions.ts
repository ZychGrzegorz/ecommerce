...
export const listUsers =(): ThunkAction<void, RootState,null,UserListAction>=> async(dispatch, getState)=>{
...
export const deleteUser =(id: string): ThunkAction<void, RootState,null,UserDeleteAction>=> async(dispatch, getState)=>{
